...
export const PROBLEMS: Problem[] = [
  // ts force type, means that this array PROBLEM has Problem[] type, and latter to identify Problem[] type
  // so in models - problem.model.ts -> identify the class problem type
  {
    id: 1,
    name: "Two Sum",
